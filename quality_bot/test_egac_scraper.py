...
try:
    from telegram_bot_quality_arabic import fetch_egac_news, extract_article_content
except ImportError as e:
    print(f"Error importing bot module: {e}")
    sys.exit(1)

def test_egac():
    print("Fetching EGAC news...")
    try:
        articles = fetch_egac_news()
        ...
        if articles:
            ...
            # Note: extract_article_content might fail if requests blocks it, but let's try
